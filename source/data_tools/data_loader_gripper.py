...
from rosmsg_dict_converter.converter import ros_message_to_dict
...
class GripperData:
    ...
    def __init__(self, base_path: Path, rec_name: str, sensor_module_name: str):
        ...
        self.bag = next(base_path.glob(f"raw/{self.rec_name}/{self.sensor_module_name}/{rec_name}_*.bag"), None)
        self.svo = next(base_path.glob(f"raw/{self.rec_name}/{self.sensor_module_name}/{rec_name}_*.svo"), None)
...
if __name__ == "__main__":
    ...
    gripper_data.extract_bag_new()
    # gripper_data.extract_svo()
    # gripper_data.extract_video()
    # 
    # gripper_data.get_trajectory_from_svo()
    # gripper_data._points_raw_to_ply()
    # gripper_data.save_trajectory_as_ply()
    # gripper_data.visualize_svo_trajectory()